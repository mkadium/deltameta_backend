...
RESOURCE_REGISTRY: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "key": "dataset",
        "label": "Dataset",
        "description": "Raw data collections (DB schemas, S3 buckets, API sources, files)",
        "operations": ["read", "create", "update", "delete"],
        "is_static": True,
    },
    {
        ...
        "key": "data_asset",
        "label": "Data Asset",
        "description": "Cataloged data assets — tables, views, files, API endpoints with metadata, ownership, and lineage",
        "operations": ["read", "create", "update", "delete", "assign_tag", "remove_tag"],
        "is_static": True,
    },
    {
        "group_slug": "data-catalog",
        "key": "data_asset_column",
        "label": "Data Asset Column",
        "description": "Column-level schema metadata for a data asset",
        "operations": ["read", "create", "update", "delete"],
        "is_static": True,
    },
    {
        ...
        "key": "data_product",
        "label": "Data Product",
        "description": "Curated, business-ready data products aggregating multiple data assets",
